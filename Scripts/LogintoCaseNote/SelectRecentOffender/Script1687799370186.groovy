...
WebUI.click(findTestObject('Object Repository/RecentOffenderAndCaseNoteNavigation/Page_Syscon/Menu Recent Offenders'))

WebUI.click(findTestObject('Object Repository/RecentOffenderAndCaseNoteNavigation/Page_Syscon/SelectRecentOffender'))
